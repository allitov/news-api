...
insert into news_schema.users (user_name, email, registration_date) values ('Emmey Crossland', 'ecrossland2@canalblog.com', '2023-06-08 19:53:03');
insert into news_schema.users (user_name, email, registration_date) values ('Chas Sapshed', 'csapshed3@noaa.gov', '2022-12-13 01:10:09');
insert into news_schema.users (user_name, email, registration_date) values ('Fina Sugden', 'fsugden4@nymag.com', '2023-04-14 06:02:56');
